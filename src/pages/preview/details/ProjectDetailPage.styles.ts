...
export const descriptionBodyStyles = cn("flex flex-col gap-3 text-sm leading-relaxed");

export const propertyListStyles = cn("grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2");
...
export const metaListStyles = cn("grid grid-cols-[1fr_auto] gap-x-4 gap-y-3 text-sm");

export const activityListStyles = cn("flex flex-col gap-3");

export const metaRowStyles = cn("flex items-center justify-between gap-4 text-sm");
