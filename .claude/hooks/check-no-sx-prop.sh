#!/bin/bash
# Enforces: NEVER use inline sx for production component styling (03-coding-principles.md, 06-styling.md, 12-mui-usage.md)
...
if [[ -n "$VIOLATIONS" ]]; then
  ...
  echo "Source: 06-styling.md, 12-mui-usage.md" >&2
  exit 2
fi
